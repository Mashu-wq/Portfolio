    ...
    <div class="container">
      <nav>
        <ul>
          ...
          <li><a href="admin.php?portfoliosetting=true">
              <i class="fas fa-tasks"></i>
              <span class="nav-item">View Portfolio</span>
            </a></li>
        ...
        <div class="row">
          ...
          <?php if (isset($_GET['homesetting'])) { ?>
            ...
            <form role="form" action="update.php" method="post">
              ...
              <textarea rows"400" cols="50" id="subtitle" name="subtitle" required><?= $data_home['subtitle'] ?></textarea>
              <br>
